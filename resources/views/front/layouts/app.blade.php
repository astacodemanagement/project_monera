...
<body>
    ...
    <div class="main-wrapper">
                ...
                <div class="container">
                    <div class="row align-items-center">
                        <div class="col-lg-2 col-md-4 col-5">
                            <div class="logo-area">
                                <a href="/"><img src="{{ asset('/upload/profil/' . $profil->logo_dark) }}"
                                        alt=""></a>
                            </div>
                        </div>
                                    ...
                                    <ul>
                                                ...
                                                <li><a href="">Tersedia</a>
                                                    <ul>
                                                        <li><a href="#" data-item="Parcel Idul Fitri">Parcel Idul
                                                                Fitri</a></li>
                                                        <li><a href="#" data-item="Parcel Natal">Parcel Natal</a>
                                                        </li>
                                                        <li><a href="#" data-item="Parcel Imlek">Parcel Imlek</a>
                                                        </li>
                                                        <li><a href="#" data-item="Parcel Anak">Parcel Anak</a>
                                                        </li>
                                                        <li><a href="#" data-item="Hampers Newborn">Hampers
                                                                Newborn</a></li>
                                                    </ul>
                                                </li>
                                                <script>
                                            ...
                                            <ul class="mega-menu" style="color:#EE4D2D">
                                                <li><a href="/">Semua Momen</a>
                                                    <ul>
                                                        ...
                                                        <li><a href="#" data-tema="Ulang Tahun">Ulang Tahun</a>
                                                        </li>
                                                        <li><a href="#" data-tema="Ucapan Selamat">Ucapan
                                                                Selamat</a></li>
                                                        <li><a href="#" data-tema="Pembukaan Toko">Pembukaan
                                                                Toko</a></li>
                                                ...
                                                <li style="padding-top: 40px;">
                                                    <ul>
                                                        ...
                                                        <li><a href="#" data-tema="Cepat Sembuh">Cepat
                                                                Sembuh</a></li>
                                                        <li><a href="#"
                                                                data-tema="Lamaran/Tunangan">Lamaran/Tunangan</a></li>
                                                        <li><a href="#" data-tema="Permintaan Maaf">Permintaan
                                                                Maaf</a></li>
                                                ...
                                                <li style="padding-top: 40px;">
                                                    <ul>
                                                        <li><a href="#" data-tema="Anniversary">Anniversary</a>
                                                        </li>
                                                        <li><a href="#" data-tema="Terima Kasih">Terima
                                                                Kasih</a></li>
                                            ...
                                            document.addEventListener('DOMContentLoaded', function() {
                                                ...
                                                document.querySelectorAll('.mega-menu a[data-tema]').forEach(function(link) {
                                                    link.addEventListener('click', function(e) {
                                                        ...
                                                        const whatsappLink =
                                                            `https://wa.me/${profilWa}?text=Hallo%20Admin%20${encodeURIComponent(profilNama)}%20saya%20ingin%20memesan%20dengan%20tema%20${encodeURIComponent(tema)}`;
                                        ...
                                        <li><a href="/">Lokasi</a>
                                            <ul class="sub-menu" style="color:#EE4D2D">
                                                ...
                                                <li><a href="#" data-lokasi="Kab Pangandaran">Kab
                                                        Pangandaran</a></li>
                                            </ul>
                                        </li>
                        ...
                        <div class="col-lg-2 col-md-8 col-7">
                            <div class="right-blok-box d-flex">
                                ...
                                <div class="shopping-cart-wrap">
                                    <a href="https://wa.me/{{ $profil->no_wa }}?text={{ urlencode('Hallo Admin ' . $profil->nama_profil . ', saya ingin bertanya terkait katalog dan layanan di ' . $profil->nama_profil . '. Terima kasih') }}"
                            ...
                            <nav>
                                <ul class="mobile-menu">
                                    <li class="menu-item-has-children"><a href="/">Katalog</a>
                                        <ul class="dropdown">
                                            <li><a href="#" data-item="Parcel Idul Fitri">Parcel Idul Fitri</a>
                                            </li>
                                    ...
                                    <li class="menu-item-has-children"><a href="/">Momen</a>
                                        <ul class="megamenu dropdown" style="color:#EE4D2D">
                                            ...
                                            <li><a href="#" data-tema="Lamaran/Tunangan">Lamaran/Tunangan</a>
                                            </li>
                                    ...
                                    <li class="menu-item-has-children"><a href="/">Lokasi</a>
                                        <ul class="dropdown">
                                            <li><a href="#" data-lokasi="Kota Tasikmalaya">Kota Tasikmalaya</a>
                                            </li>
                                            <li><a href="#" data-lokasi="Kab Tasikmalaya">Kab Tasikmalaya</a>
                                            </li>
                                            <li><a href="#" data-lokasi="Kab Ciamis">Kab Ciamis</a></li>
                                            <li><a href="#" data-lokasi="Kab Garut">Kab Garut</a></li>
                                            <li><a href="#" data-lokasi="Kota Banjar">Kota Banjar</a></li>
                                            <li><a href="#" data-lokasi="Kab Pangandaran">Kab Pangandaran</a>
                                            </li>
                                        </ul>
                                    </li>
                                    <script>
        ...
        <a href="https://wa.me/{{ $profil->no_wa }}?text={{ urlencode('Halo ' . $profil->nama_profil . ', Saya ingin pesan Parcel By Monera. Bisa dibantu?') }}"
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="widget-footer mt-20">
                                <div class="footer-logo">
                                    <a href="/"><img src="{{ asset('/upload/profil/' . $profil->logo) }}"
                                            alt=""></a>
                                </div>
                                <p>{{ $profil->nama_profil }} berkomitmen untuk memberikan kualitas dan layanan terbaik
                                    untuk menyempurnakan ungkapan kasih dan ucapan Anda.</p>
                        ...
                        <div class="col-lg-2 col-md-6">
                            <div class="widget-footer mt-30">
                                ...
                                <ul class="footer-list">
                                    ...
                                    <li>
                                        <a href="#" id="whatsappLink">Daerah Pengiriman</a>
                                    </li>
                                    ...
                                    <script>
                                        document.getElementById('whatsappLink').addEventListener('click', function(event) {
                                            ...
                                            var profilNama = "{{ $profil->nama_profil }}"; // Nama profil dari backend Laravel
                                            var nomorWA = "{{ $profil->no_wa }}"; // Nomor WhatsApp dari backend Laravel
                                            var message = `Halo Admin ${profilNama}, saya ingin menanyakan pengiriman ke daerah...`;

                                            var whatsappUrl = `https://wa.me/${nomorWA}?text=${encodeURIComponent(message)}`;
                                            window.open(whatsappUrl, '_blank');
                                        });
                                    </script>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="copy-right-text text-center">
                                <p>Copyright &copy; <a href="/">{{ $profil->nama_profil }}</a>
